...
class CustomerOrderForm(forms.ModelForm):
    ...
    class Meta:
        model = CustomerOrder
        fields = ['client', 'order_date', 'delivery_date', 'status', 'description', 'notes']
        widgets = {
...
class SupplierOrderForm(forms.ModelForm):
    """Form for supplier orders"""

    class Meta:
        model = SupplierOrder
        fields = ['supplier', 'order_date', 'expected_delivery', 'status', 'description', 'notes']
        widgets = {
...
class SupplierOrderItemForm(forms.ModelForm):
    """Form for supplier order items"""

    class Meta:
        model = SupplierOrderItem
        fields = ['product', 'description', 'quantity', 'unit_price', 'tax_rate', 'quantity_received']
        widgets = {
            'product': forms.Select(attrs={
                'class': 'w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500'
            }),
