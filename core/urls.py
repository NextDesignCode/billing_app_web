# ============================================================================
# core/urls.py - Updated with all modules
# ============================================================================
...
urlpatterns = [
    ...
    # Login & Logout (kept for backward compatibility)
    path('login/', views.CustomLoginView.as_view(), name='login'),
    path('logout/', views.CustomLogoutView.as_view(), name='logout'),

    # Invoices CRUD
    path('invoices/', crud_views.invoice_list, name='invoice_list'),
    path('invoices/<uuid:pk>/', crud_views.invoice_detail, name='invoice_detail'),
    ...
    path('clients/<uuid:pk>/', crud_views.client_detail, name='client_detail'),
    ...
    # Products CRUD
    path('products/', crud_views.product_list, name='product_list'),
    path('products/<uuid:pk>/', crud_views.product_detail, name='product_detail'),
